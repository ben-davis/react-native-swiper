...
module.exports = _react2.default.createClass({
  ...
  injectState: function injectState(props) {
    ...
    for (var prop in props) {
      ...
      if (typeof props[prop] === 'function' && prop !== 'onMomentumScrollEnd' && prop !== 'renderPagination' && prop !== 'onScrollBeginDrag' && prop !== 'onChange' && prop !== 'onScroll' && prop !== 'onKeyboardDidHide' && prop !== 'onKeyboardDidShow' && prop !== 'onKeyboardWillHide' && prop !== 'onKeyboardWillShow') {
        (function () {
